...
print(datetime.now())
graph = ox.graph_from_place("Saint-Léonard, Montréal, Canada", network_type='drive') #juste voiture
...
circuit = depart_deneigeuse(circuit, 218198366)
...
#ici on fait avec véhicule le plus rapide/plus chere
...
conso = 1.3
prix_time = 0
#1,3€ /h les 8premieres heures puis 1,3€ /h
if temps > 8:
